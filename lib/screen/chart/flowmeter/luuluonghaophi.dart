...
class LuuLuongHaoPhiPage extends StatefulWidget {
  @override
  _LuuLuongHaoPhiPageState createState() => _LuuLuongHaoPhiPageState();
}

class _LuuLuongHaoPhiPageState extends State<LuuLuongHaoPhiPage> {
  ...
  loadData() async {
    ...
    apiService
      ...
      if (value.statusCode == 200) {
        luuLuongDauVao = value.data.luuLuongHaoPhi;
      }else {
