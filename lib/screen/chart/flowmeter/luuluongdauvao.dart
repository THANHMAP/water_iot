...
class LuuLuongDauVaoPage extends StatefulWidget {
  @override
  _LuuLuongDauVaoPageState createState() => _LuuLuongDauVaoPageState();
}

class _LuuLuongDauVaoPageState extends State<LuuLuongDauVaoPage> {
  ...
  loadData() async {
    ...
    apiService
      ...
      if (value.statusCode == 200) {
        luuLuongDauVao = value.data.luuLuongDauVao;
      }else {
