...
class ChiPhiDienPage extends StatefulWidget {
  @override
  _ChiPhiDienPageState createState() => _ChiPhiDienPageState();
}

class _ChiPhiDienPageState extends State<ChiPhiDienPage> {
  ...
  Widget _buildListView() {
    return ListView.builder(
        itemCount: chiPhiDien == null ? 0 : chiPhiDien.length,
        itemBuilder: (context, index) {
          return _buildItem(chiPhiDien[index]);
        });
  }

  Widget _buildItem(ChiPhiDien chiPhiDien) {
    return Padding(
        ...
        children: <Widget>[
          ...
          InkWell(
            ...
            child: Column(
              ...
              children: <Widget>[
                for (var i = 0; i < chiPhiDien.dataList.length; i++)
                  Container(
  ...
  loadData() async {
    ...
    apiService
      ...
      if (value.statusCode == 200) {
        chiPhiDien = value.data.chiPhiDien;
      } else {
