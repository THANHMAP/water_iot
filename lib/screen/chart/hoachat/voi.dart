                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: new Text(
                        dataChemical == null
                            ? ""
                            : dataChemical.congThucHoaChat.title,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                              formatter
                                  .format(congthuchoachat.infoKg.kg.toInt()),
                              style: TextStyle(
                                  color: Colors.grey[800], fontSize: 17)),
                          RichText(
                            text: WidgetSpan(
                              ...
                              Expanded(
                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      loadTable(dataChemical.khoHoaChat.dataList[i])
                                    ]),
                              ),
                            ],
                          ),
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: new Text(
                        dataChemical == null
                            ? ""
                            : dataChemical.hoaChatTieuThu.title,
                        textAlign: TextAlign.left,
                      ),
                    ),
                  )
