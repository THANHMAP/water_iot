...
class PolymePage extends StatefulWidget {
  @override
  _PolymePageState createState() => _PolymePageState();
}

class _PolymePageState extends State<PolymePage> {
                        ...
                        new Row(
                          children: [
                            Expanded(
                              child: Container(
                                child: Text(
                                  dataChemical.congThucHoaChat.dataList[i]
                                              .title ==
                                          null
                                      ? ""
                                      : dataChemical
                                          .congThucHoaChat.dataList[i].title,
                                  style: TextStyle(
  ...
  Widget loadTable(Info info) {
    if (info.khoiLuongConLai != null) {
      return Container(
        margin: const EdgeInsets.only(top: 10.0),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Text(formatter.format(info.khoiLuongConLai.toInt()),
      ...
      return Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Text(formatter.format(info.khoiLuongDaNhap.toInt()),
                style: TextStyle(color: Colors.grey[800], fontSize: 17)),
            RichText(
              text: WidgetSpan(
                child: Container(
  ...
  loadData() async {
    ...
    apiService.getListChemical(factoryLocal.factoryId.toString()).then((value) {
      ...
      if (value.statusCode == 200) {
        dataChemical = value.data.polyme;
      } else {
